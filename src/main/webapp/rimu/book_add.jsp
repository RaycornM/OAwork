				...
				<div class="main-login">
					...
					<div class="loginarea">
						<div class="contactform">
							<form method="post" action="/OAwork/addbook">
								<fieldset>
									<legend>
										&nbsp;基本信息&nbsp;
									</legend>
									<p>
										...
										<input type="text" name="isbn" id="isbn" class="field"
											value="" tabindex="1" />
									</p>
									...
									<p>
										...
										<input type="text" name="author" id="author" class="field" value=""
											tabindex="1" />
									</p>
									...
									<p>
										...
										<input type="text" name="press" id="press" class="field" value=""
											tabindex="1" />
									</p>
